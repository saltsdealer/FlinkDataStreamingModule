...
public class DwmUserJumpDetailApp_1 extends AppModelV1 {
    public static void main(String[] args) {
        new DwmUserJumpDetailApp_1().init(3002,
                                          1,
    ...
    public void run(StreamExecutionEnvironment env,
        ...
        normal
            ...
            .addSink(FlinkSinkUtil.getKafkaSink(Constants.TOPIC_DWM_USER_JUMP_DETAIL));
